...
//       <h2 style={styles.title}>Estimated Salary</h2>
...
//   if (confidence === "High") color = "#2ecc71";
//   else if (confidence === "Medium") color = "#f39c12";
//   else if (confidence === "Low") color = "#e74c3c";
...
// client/src/features/salary/components/SalaryCard.jsx

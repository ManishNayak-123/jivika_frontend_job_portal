...
// const Footer = () => {
//   // 2. Access the user from your Redux store
...
//         {/* Only show this column if the user is a recruiter */}
//         {user && user.role === 'recruiter' ? (
//           <div>
//             <h4 className="text-xl font-bold mb-6 border-b-2 border-[#ff9933] inline-block">Employers</h4>
//             <ul className="space-y-4">
//               <li><Link to="/admin/jobs/create" className="hover:text-[#ff9933] transition">Post a Job</Link></li>
//               <li><Link to="/admin/companies" className="hover:text-[#ff9933] transition">Register Company</Link></li>
//               <li><Link to="/admin/jobs" className="hover:text-[#ff9933] transition">Manage Jobs</Link></li>
//               <li><Link to="/resources" className="hover:text-[#ff9933] transition">HR Resources</Link></li>
//             </ul>
//           </div>
//         ) : (
//           /* Optional: Show something else for students, like 'Support' or 'Trending' */
//           <div>
...
//               <span className="text-sm">123 Job Lane, Tech City, India</span>
//             </li>
//             <li className="flex items-center">
...
//       {/* Bottom Bar */}
//       <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-white/10 text-center text-sm text-gray-300">
//         <p>&copy; {new Date().getFullYear()} JiViKa Job Portal. All Rights Reserved.</p>
//       </div>
//     </footer>
//   );
// };
